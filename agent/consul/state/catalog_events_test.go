...
func TestServiceHealthEventsFromChanges(t *testing.T) {
	cases := []struct {
		...
		//{
		//	Name: "terminating gateway registered before config entry exists",
		//  WantEvent: []stream.Event{},
		//},
		//{
		//	Name: "terminating gateway modified",
		//},
		//{
		//	Name: "terminating gateway deregistered",
		//},
	}
